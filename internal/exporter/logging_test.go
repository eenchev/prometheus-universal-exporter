...
func TestMetricExtractionErrorIsLoggedAsJSON(t *testing.T) {
	...
	if !transform.HandleMetricError(collector, rule, errors.New(`metric "exchange_rate_observation_timestamp_seconds" value is missing`)) {
...
func TestIgnoreErrorModeLogsNothing(t *testing.T) {
	...
	if !transform.HandleMetricError(collector, model.MetricRule{Name: "ignored", ErrorMode: model.ErrorModeIgnore}, errors.New("boom")) {
...
func TestFailErrorModeLogsAndStops(t *testing.T) {
	...
	if transform.HandleMetricError(collector, model.MetricRule{Name: "failing", ErrorMode: model.ErrorModeFail}, errors.New("boom")) {
...
func TestMetricErrorWithoutACollectorStillLogs(t *testing.T) {
	out := testutil.CaptureLogs(t)
	if !transform.HandleMetricError(nil, model.MetricRule{Name: "orphan", ErrorMode: "log"}, errors.New("boom")) {
