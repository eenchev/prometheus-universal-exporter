...
func init() {
	registerRequestType(&requestType{
		...
		OptionalTarget: true,
		CheckTarget: func(c *Collector, target string, _ bool) error {
...
func validateLocalFileRequest(x *Collector) error {
...
// one; it may be empty.
func localFileTargetDir(c *Collector, target string) (string, error) {
...
func resolveLocalFile(target string, c *Collector, overrides RequestOverrides, bind bool) (string, error) {
